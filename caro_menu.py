...
class CaroUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Vietnam Aviation Academy-Artificial-Intelligence-Group-5")
        self.root.geometry("500x450") # Đặt kích thước cửa sổ
    ...
    def start_game(self):
        ...
        self.root.destroy()
        game = Game(size=size, gamemode=mode)
        game.mainloop()
